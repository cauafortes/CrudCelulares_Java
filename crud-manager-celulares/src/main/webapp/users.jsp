...
<html lang="pt-br">
<head>
<title>Usuários - crud-manager-celulares</title>
...
<%@include file="modal.html"%>
    ...
    <div id="container" class="container-fluid">
        ...
        <div id="top" class="row">
            ...
            <div class="col-md-3">
                <a href="<%= request.getContextPath() %>/user/form" class="btn btn-danger pull-right h2"><span class="glyphicon glyphicon-plus" /></span>&nbspAdicionar Usuário</a>
            </div>
        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(".modal-remove").click(function () {
                ...
                $("#form").attr( "action","<%= request.getContextPath() %>/user/delete");
            })
        });
    </script>
</body>
