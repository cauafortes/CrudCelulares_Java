...
<head>
    ...
    <title><c:out value="${not empty user ? 'Alterar' : 'Adicionar'} Usuário - crud-manager-celulares" /></title>
</head>
<body>
    <jsp:include page="/nav-menu.jsp" />

    <div id="container" class="container-fluid">
        <h3 class="page-header">${not empty user ? 'Alterar Usuário' : 'Adicionar Usuário'}</h3>
