...
<body>
	...
	<div id="container" class="container-fluid">
		...
		<div id="top" class="row">
		    ...
		    <div class="col-md-3">
		        <a href="<%= request.getContextPath() %>/company/form" class="btn btn-danger pull-right h2"><span class="glyphicon glyphicon-plus" /></span>&nbspAdicionar Empresa</a>
		    </div>
     	</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
		    ...
		    $(".modal-remove").click(function () {
	            ...
	            $("#form").attr( "action","<%= request.getContextPath() %>/company/delete");
	        })
		});
	</script>
</body>
