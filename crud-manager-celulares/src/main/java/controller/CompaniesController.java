...
public class CompaniesController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		case "/crud-manager-celulares/company/insert":
			insertCompany(req, resp);
			break;
		case "/crud-manager/company/delete":
		case "/crud-manager-celulares/company/delete":
		...
		try {
			...
			if (dao.delete(company)) {
				...
				ControllerUtil.errorMessage(req,
						"Empresa '" + company.getName() + "' não pode ser deletado. Há dados relacionados à empresa.");
			}
		} catch (ModelException e) {
